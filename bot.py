...
AVAILABLE_MODELS = {
    "deepseek-chat": {"description": "通用对话模型，平衡性能和速度。", "supports_vision": False},
    "deepseek-coder": {"description": "代码生成和理解模型。", "supports_vision": False},
    "deepseek-reasoner": {"description": "推理模型，擅长复杂逻辑和思维链。", "supports_vision": False},
}
